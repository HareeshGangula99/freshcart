    ...
    <div className="d-flex" style={{ minHeight: '100vh', background: '#f8f7f4' }}>
      ...
      <div className="d-none d-lg-flex align-items-center justify-content-center position-relative" style={{ width: '48%', background: 'linear-gradient(160deg, #0a3d2e 0%, #0d6b4a 35%, #10b981 70%, #34d399 100%)', overflow: 'hidden' }}>
        ...
        <div className="position-relative text-white" style={{ maxWidth: '440px', zIndex: 10, padding: '60px' }}>
          ...
          <h2 className="fw-bold mb-3" style={{ fontSize: '44px', lineHeight: 1.15, fontFamily: "'Plus Jakarta Sans', sans-serif", letterSpacing: '-1px' }}>
            Start your fresh<br />journey today.
          </h2>
          <p style={{ fontSize: '17px', lineHeight: 1.7, marginBottom: '48px', color: 'rgba(255,255,255,0.75)', maxWidth: '400px' }}>
            Create an account and get access to the freshest produce at your fingertips.
          </p>
          <div className="d-flex flex-column gap-3">
            {['Free delivery on first order', 'Exclusive deals & offers', 'Real-time order tracking'].map((text, i) => (
      ...
      <div className="d-flex align-items-center justify-content-center flex-grow-1 p-3 p-md-4">
        <div style={{ width: '100%', maxWidth: '420px' }} className="animate-fade-in">
          ...
          <div className="mb-4">
            <h2 className="fw-bold text-dark mb-1" style={{ fontSize: '28px', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Create account</h2>
            <p className="text-muted" style={{ fontSize: '15px' }}>Fill in your details to get started</p>
          </div>
          ...
          <div className="card border-0 shadow-sm p-3 p-md-4 rounded-4">
            ...
            <button
              type="button"
              onClick={() => { setSignupMethod(signupMethod === 'phone' ? 'email' : 'phone'); setError(''); setSuccess(''); }}
              className="btn w-100 fw-semibold rounded-3 py-2 d-flex align-items-center justify-content-center gap-2 mb-3"
              style={{ border: '1.5px solid #e5e7eb', fontSize: '14px', color: '#374151', background: '#fff' }}
            >
              <i className={`bi ${signupMethod === 'phone' ? 'bi-envelope' : 'bi-phone'}`}></i>
              {signupMethod === 'phone' ? 'Continue with Email' : 'Continue with Phone'}
            </button>
            ...
            {signupMethod === 'phone' ? (
              ...
              <>
                ...
                <form onSubmit={handleSubmit}>
                  <div className="mb-3">
                    <label className="form-label fw-semibold" style={{ fontSize: '13px', color: '#374151' }}>Full name</label>
                    <div className="position-relative">
                      <i className="bi bi-person position-absolute" style={{ left: '14px', top: '50%', transform: 'translateY(-50%)', color: '#9ca3af' }}></i>
                      <input name="name" type="text" className="form-control fc-input" style={{ paddingLeft: '42px' }} placeholder="John Doe" value={formData.name} onChange={handleChange} required />
                    </div>
                  </div>
                  <div className="mb-3">
                    ...
                    <div className="position-relative">
                      ...
                      <input name="email" type="email" className="form-control fc-input" style={{ paddingLeft: '42px' }} placeholder="you@example.com" value={formData.email} onChange={handleChange} required />
                    </div>
                  </div>
                  <div className="mb-4">
                    ...
                    <div className="position-relative">
                      ...
                      <input name="password" type="password" className="form-control fc-input" style={{ paddingLeft: '42px' }} placeholder="Create a strong password" value={formData.password} onChange={handleChange} required minLength={6} />
                    </div>
                  </div>
          ...
          <p className="text-center mt-4" style={{ fontSize: '14px', color: '#6b7280' }}>
            ...
            <Link to="/login" className="text-decoration-none fw-bold" style={{ color: '#059669' }}>Sign in <i className="bi bi-arrow-up-right"></i></Link>
          </p>
